...
<div class="wrap">
<h2>Сайты <a href="https://metrika.yandex.ru/stat/sites?id=<?php echo $dl_metrika_id; ?>" target="_blank" style="float: right" class="button">Отчет на Yandex.Metrika</a></h2>
...
<?php
	...
	<thead>
		<tr>
			<th class="manage-column column-title"><a>Внешний реферер</a></th>
	...
	<tbody>
		...
		{ 
			$name	= $json_data[$key][dimensions][0][favicon];
			$name_url	= $json_data[$key][dimensions][0][name];
		...
		?>  
		<tr>
			<th class="manage-column column-title"><a href="<?php echo $name_url; ?>" target="_blank"><?php echo $name; ?></a></th>
