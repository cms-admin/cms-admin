...
<div class="wrap">
<h2>Источники, сводка <a href="https://metrika.yandex.ru/stat/sources?id=<?php echo $dl_metrika_id; ?>" target="_blank" style="float: right" class="button">Отчет на Yandex.Metrika</a></h2>
...
<?php
	...
	<thead>
		<tr>
			<th class="manage-column column-title"><a>Источник трафика</a></th>
